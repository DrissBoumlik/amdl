			...
			?>
				...
				<?php
					...
					if($custom['normal_post_author'])
						echo '<div class="author"><i class="fa fa-user"></i> ' . (!empty($custom['normal_post_author'][0]) ? $custom['normal_post_author'][0]  : 'برلمان.كوم') . '</div>';
					else
						echo '<div class="author"><i class="fa fa-user"></i> برلمان.كوم</div>';
