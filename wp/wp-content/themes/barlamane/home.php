...
<!-- /105888583/barlamane-pave-300x250 -->
<div id='div-gpt-ad-1539631470247-0'>
<script>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1539631470247-0'); });
</script>
</div>
	         </div>
		  </div>	
    	...
    	<div class="widget">
            <form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
                <input type="text" value="<?php the_search_query(); ?>" placeholder="أكتب كلمة البحث هنا" name="s" id="search_input" /><!--
		...
		<div class="widget">
			...
			<?php hybrid_videos_list(4,17534,'video');?>
		</div>
		<div class="widget">
    			<div class="cat-header" style="background-color:#34495e;">
		...
		<div class="widget">
			...
			<?php hybrid_videos_list(4,4,'video');?>
		</div>
		<div class="widget">
	         <div class="ads-300 ads">
<!-- /105888583/barlamane-pave-300x250 -->
